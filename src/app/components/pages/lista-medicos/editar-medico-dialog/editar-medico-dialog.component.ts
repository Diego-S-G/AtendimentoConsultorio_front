...
@Component({
  selector: 'app-editar-medico-dialog',
  templateUrl: './editar-medico-dialog.component.html',
  styleUrls: ['./editar-medico-dialog.component.scss']
})
export class EditarMedicoDialogComponent implements OnInit {
